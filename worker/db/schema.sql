...
INSERT OR IGNORE INTO models (slug, display_name, provider, sort_order) VALUES
    ...
    ('gpt-4o', 'GPT-4o', 'OpenAI', 10),
    ('gpt-4.1', 'GPT-4.1', 'OpenAI', 11),
    ('gpt-4.1-mini', 'GPT-4.1 Mini', 'OpenAI', 12),
    ('o3', 'o3', 'OpenAI', 13),
    ('o4-mini', 'o4-mini', 'OpenAI', 14),
    ('codex-1', 'Codex', 'OpenAI', 15),
    ('gemini-2.5-pro', 'Gemini 2.5 Pro', 'Google', 20),
    ('gemini-2.5-flash', 'Gemini 2.5 Flash', 'Google', 21),
    ('grok-3', 'Grok 3', 'xAI', 30),
    ('grok-4', 'Grok 4', 'xAI', 31),
